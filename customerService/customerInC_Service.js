...
async function createCustomerInC_ServiceOne(page){
  ...
  await page.getByRole('textbox', { name: 'Email *' }).fill('akbk6551+1518@gmail.com');
  await page.getByRole('textbox', { name: 'Person In Charge *' }).click();
  await page.getByRole('textbox', { name: 'Person In Charge *' }).fill('Sushil Rastogi');
  ...
  await page.getByRole('textbox', { name: 'email@example.com' }).fill('akbk6551+1249@gmail.com');
  await page.getByRole('textbox', { name: 'Phone number' }).click();
  await page.getByRole('textbox', { name: 'Phone number' }).fill('7896425411');
...
async function editCustomerInC_Service(page){
 ...
 await page.getByRole('row', { name: 'Anil Rathor akbk6551+1136@' }).getByLabel('Edit').click();
  ...
  await page.getByRole('option', { name: 'Jay kumar Rathor' }).first().click();
...
//     page.getByRole('button', { name: 'Export To Excel' }).click()
//   ]);
//   await excelDownload1.saveAs('downloads/exportCustomerInC_ServiceFilter1.xlsx');
//   const result3 = await dataRead(
//         "./downloads/exportCustomerInC_ServiceFilter1.xlsx",
...
//   ) 
//       {
//           await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter1.png`, fullPage: true });
...
async function exportCustomerInC_ServiceFilter(page){
  ...
  await excelDownload.saveAs('downloads/exportCustomerInC_ServiceFilter1.xlsx');
  ...
  if (result.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter1.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter1","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter1.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter1.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter1","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter1.png`)
        }
 ...
 const result1 = await dataRead(
  ...
  await excelDownload1.saveAs('downloads/exportCustomerInC_ServiceFilter3.xlsx');
  const result2 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter3.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
    console.log(result2);
 ...
 const result3 = await dataRead(
  ...
  await excelDownload2.saveAs('downloads/exportCustomerInC_ServiceFilter5.xlsx');
  const result4 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter5.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
    console.log(result4);
  ...
  if (result4.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter5.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter5","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter5.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter5.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter5","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter5.png`)
        }
 ...
 const result5 = await dataRead(
  ...
  await excelDownload3.saveAs('downloads/exportCustomerInC_ServiceFilter7.xlsx');
  const result6 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter7.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
    console.log(result6);
  ...
  if (result6.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter7.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter7","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter7.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter7.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter7","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter7.png`)
        }
 ...
 const result7 = await dataRead(
  ...
  await excelDownload4.saveAs('downloads/exportCustomerInC_ServiceFilter9.xlsx');
  const result8 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter9.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
    console.log(result8);
  ...
  if (result8.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter9.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter9","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter9.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter9.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter9","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter9.png`)
        }
 ...
 const result9 = await dataRead(
  ...
  await excelDownload6.saveAs('downloads/exportCustomerInC_ServiceFilter11.xlsx');
  const result10 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter11.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
    console.log(result10);
  ...
  if (result10.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter11.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter11","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter11.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter11.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter11","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter11.png`)
        }
 ...
 const result11 = await dataRead(
  ...
  await excelDownload7.saveAs('downloads/exportCustomerInC_ServiceFilter13.xlsx');
  const result12 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter13.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result12.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter13.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter13","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter13.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter13.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter13","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter13.png`)
        }
 ...
 const result13 = await dataRead(
  ...
  await excelDownload8.saveAs('downloads/exportCustomerInC_ServiceFilter15.xlsx');
  const result14 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter15.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result14.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter15.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter15","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter15.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter15.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter15","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter15.png`)
        }
 ...
 await page.getByRole('button', { name: 'Filter By' }).click();
  ...
  await excelDownload9.saveAs('downloads/exportCustomerInC_ServiceFilter17.xlsx');
  const result16 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter17.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result16.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter17.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter17","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter17.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter17.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter17","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter17.png`)
        }
 ...
 const result17 = await dataRead(
  ...
  await excelDownload10.saveAs('downloads/exportCustomerInC_ServiceFilter19.xlsx');
  const result18 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter19.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result18.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter19.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter19","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter19.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter19.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter19","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter19.png`)
        }
 ...
 const result19 = await dataRead(
  ...
  await excelDownload11.saveAs('downloads/exportCustomerInC_ServiceFilter21.xlsx');
  const result20 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter21.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result20.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter21.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter21","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter21.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter21.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter21","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter21.png`)
        }
 ...
 const result21 = await dataRead(
  ...
  await excelDownload12.saveAs('downloads/exportCustomerInC_ServiceFilter23.xlsx');
  const result22 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter23.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result22.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter23.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter23","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter23.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter23.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter23","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter23.png`)
        }
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  await excelDownload13.saveAs('downloads/exportCustomerInC_ServiceFilter25.xlsx');
  const result24 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter25.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result23.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter25.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter25","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter25.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter25.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter25","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter25.png`)
        }
 ...
 const result25 = await dataRead(
  ...
  await excelDownload14.saveAs('downloads/exportCustomerInC_ServiceFilter27.xlsx');
  const result26 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter27.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result26.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter27.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter27","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter27.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter27.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter27","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter27.png`)
        }
 ...
 const result27 = await dataRead(
  ...
  await excelDownload15.saveAs('downloads/exportCustomerInC_ServiceFilter29.xlsx');
  const result28 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter29.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result28.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter29.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter29","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter29.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter29.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter29","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter29.png`)
        }
 ...
 const result29 = await dataRead(
  ...
  await excelDownload16.saveAs('downloads/exportCustomerInC_ServiceFilter31.xlsx');
  const result30 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter31.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result30.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter31.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter31","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter31.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter31.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter31","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter31.png`)
        }
 ...
 const result31 = await dataRead(
  ...
  await excelDownload17.saveAs('downloads/exportCustomerInC_ServiceFilter34.xlsx');
  const result33 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter34.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result33.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter34.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter34","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter34.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter34.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter34","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter34.png`)
        }
 ...
 const result34 = await dataRead(
  ...
  await excelDownload18.saveAs('downloads/exportCustomerInC_ServiceFilter36.xlsx');
  const result35 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter36.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result35.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter36.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter36","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter36.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter36.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter36","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter36.png`)
        }
 ...
 const result36 = await dataRead(
  ...
  await excelDownload19.saveAs('downloads/exportCustomerInC_ServiceFilter38.xlsx');
  const result37 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter38.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result37.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter38.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter38","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter38.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter38.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter38","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter38.png`)
        }
 ...
 const result38 = await dataRead(
  ...
  await excelDownload20.saveAs('downloads/exportCustomerInC_ServiceFilter40.xlsx');
  const result39 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter40.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result39.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter40.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter40","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter40.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter40.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter40","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter40.png`)
        }
 ...
 const result40 = await dataRead(
  ...
  await excelDownload21.saveAs('downloads/exportCustomerInC_ServiceFilter42.xlsx');
  const result41 = await dataRead(
        "./downloads/exportCustomerInC_ServiceFilter42.xlsx",
        ["Imran Khan","akbk6551+1222@gmail.com"],
        ["Anil Maurya","akbk6551+1112@gmail.com"]
    );
  ...
  if (result41.success 
    ...
    && !await page.getByText('akbk6551+1217@gmail.com').isVisible() )
      {
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter42.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter42","true",`./${screenshotPath}/exportCustomerInC_ServiceFilter42.png`)
          
        }
        else{
          await page.screenshot({ path: `./${screenshotPath}/exportCustomerInC_ServiceFilter42.png`, fullPage: true });
          await updateOpJson(`./${screenshotPath}/`,"exportCustomerInC_ServiceFilter42","false",`./${screenshotPath}/exportCustomerInC_ServiceFilter42.png`)
        }
