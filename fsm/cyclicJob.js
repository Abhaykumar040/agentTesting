...
async function createCyclicJob(page){
  ...
  await page.getByRole('textbox', { name: 'Job Title' }).fill('Intallation6');
  ...
  await page.getByRole('textbox', { name: 'Schedule Start Date' }).fill('2026-06-12');
  await page.getByRole('textbox', { name: 'Schedule End Date' }).fill('2027-06-28');
  ...
  await page.getByRole('textbox', { name: 'Schedule Start Date' }).fill('2026-05-23');
